            ...
            <Card className="p-6 dark:bg-card">
              ...
              <div className="mt-6 space-y-3 border-t dark:border-border pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-lg dark:text-white">${Math.round(invoice.subtotal).toLocaleString('es-CO')}</span>
                </div>
                ...
                {invoice.hasTax ? (
                  <div className="flex justify-between items-center bg-gray-50 dark:bg-muted p-3 rounded-lg">
                    ...
                    <span className="font-semibold text-lg dark:text-white">${Math.round(invoice.tax).toLocaleString('es-CO')}</span>
                  </div>
                ) : (
                ...
                <div className="flex justify-between items-center text-xl font-bold border-t dark:border-border pt-3">
                  ...
                  <span className="text-lime-700 dark:text-lime-400">${Math.round(invoice.total).toLocaleString('es-CO')}</span>
                </div>
              </div>
            </Card>
